...
const ccpPath = path.resolve(__dirname, '..', 'network', 'connection3.json');
...
async function main() {
    try {
        ...
        const secret = await ca.register({ affiliation: 'org3.department3', enrollmentID: 'user5', role: 'client' }, adminIdentity);
        console.log(secret);
